...
# The API key must be stored in Streamlit Secrets (GOOGLE_API_KEY) — never
# hardcoded here, to prevent it from being exposed in the public repository.
...
os.environ["GOOGLE_GENAI_USE_VERTEXAI"] = str(_use_vertexai)
